<%@ Page Title="" Language="C#" MasterPageFile="~/Content/MasterPanel.master" AutoEventWireup="true" CodeFile="CountryList.aspx.cs" Inherits="MasterPanel_Country_CountryList" %>
                ...
                <asp:GridView ID="gvCountryList" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-bordered" OnRowCommand="gvCountryList_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlEdit" Text="Edit" NavigateUrl='<%# "~/AB/AdminPanel/Country/Edit/" + Eval("CountryID").ToString() %>' CssClass="btn btn-warning" runat="server" />
