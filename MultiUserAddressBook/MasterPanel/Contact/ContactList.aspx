<%@ Page Title="" Language="C#" MasterPageFile="~/Content/MasterPanel.master" AutoEventWireup="true" CodeFile="ContactList.aspx.cs" Inherits="MasterPanel_Contact_ContactList" %>
                ...
                <asp:GridView ID="gvContactList" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-bordered" OnRowCommand="gvContactList_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlEdit" Text="Edit" NavigateUrl='<%# "~/AB/AdminPanel/Contact/Edit/" + Eval("ContactID").ToString() %>' CssClass="btn btn-warning" runat="server" />
